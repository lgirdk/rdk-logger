...
static void usage(const char* app_name)
{
    ...
    printf("               Possible values - FATAL,ERROR,WARN,NOTICE,INFO,DEBUG,TRACE1-TRACE9\n");
...
static char validate_loglevel(const char* level)
{
    ...
    else if(0 == strncmp(loglevel,"TRACE1",6))
        return negate|RDK_LOG_TRACE1;
    else if(0 == strncmp(loglevel,"TRACE2",6))
        return negate|RDK_LOG_TRACE2;
    else if(0 == strncmp(loglevel,"TRACE3",6))
        return negate|RDK_LOG_TRACE3;
    else if(0 == strncmp(loglevel,"TRACE4",6))
        return negate|RDK_LOG_TRACE4;
    else if(0 == strncmp(loglevel,"TRACE5",6))
        return negate|RDK_LOG_TRACE5;
    else if(0 == strncmp(loglevel,"TRACE6",6))
        return negate|RDK_LOG_TRACE6;
    else if(0 == strncmp(loglevel,"TRACE7",6))
        return negate|RDK_LOG_TRACE7;
    else if(0 == strncmp(loglevel,"TRACE8",6))
        return negate|RDK_LOG_TRACE8;
    else if(0 == strncmp(loglevel,"TRACE9",6))
        return negate|RDK_LOG_TRACE9;
    else
